                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="well brown">
                         <form action="${ctx}/product/exUpdate.do"  method="post" enctype="multipart/form-data">
                            <div class="form_list"><label class="lable_title">商品名称</label>
                            <input class="form_input" name="name" type="text" value="${obj.name}"/></div>
                             <input class="form_input" name="id" type="hidden" value="${obj.id }"/>
                            <div class="form_list"><label class="lable_title">商品价格</label>
                            <input class="form_input" name="price" type="text" value="${obj.price}"/></div>
                             <div class="form_list"><label class="lable_title">商品图片</label>
                           <input class="form_input" type="file" name="file" id=""  value="${obj.image}"></div>
                            <div class="form_list"><label class="lable_title">描&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;述</label>
                            <input class="form_input" type="text" name="remark" value="${obj.remark}"/></div>
                              <div class="form_list"><label class="lable_title">二级分类</label>&nbsp;&nbsp;&nbsp;&nbsp;
                            <select name="categorySecId" >
                              <c:forEach  items="${categorySecList}" var="cl" varStatus="l">
                              <c:choose>
                              <c:when test="${obj.categorySecId== cl.id}">
