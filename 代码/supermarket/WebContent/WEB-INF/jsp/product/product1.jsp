...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
<%-- 					<img src="${ctx}/resource/common/image\r___________renleipic_01/header.jpg" alt="正品保障" title="正品保障" height="50" width="320"> --%>
</div>	</div>
...
<!-- 							<del>￥1000000元</del> -->
			...
			<form id="cartForm" action="${ctx}/cart/addCart.do" method="post" >
